...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 314586010, ; hash 0x12c0339a, from name: EvolApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1169310712, ; hash 0x45b243f8, from name: libaot-EvolApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 129
	...
	%struct.DSOCacheEntry {
		i64 2325234250, ; hash 0x8a98424a, from name: aot-EvolApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 261
	...
	%struct.DSOCacheEntry {
		i64 3512070954, ; hash 0xd155f32a, from name: aot-EvolApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 404
	...
	%struct.DSOCacheEntry {
		i64 3854246183, ; hash 0xe5bb2127, from name: EvolApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 441
	...
	%struct.DSOCacheEntry {
		i64 4242913575, ; hash 0xfce5b927, from name: libaot-EvolApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 485
