...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1420256148938419806, ; hash 0x13b5c3714f89ee5e, from name: libaot-EvolApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 33
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4717310797682772890, ; hash 0x4177412d56ff0b9a, from name: EvolApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	...
	%struct.DSOCacheEntry {
		i64 5481209290508157963, ; hash 0x4c112acf1c4f440b, from name: libaot-EvolApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 135
	...
	%struct.DSOCacheEntry {
		i64 11468209122168533461, ; hash 0x9f27436f78bff1d5, from name: aot-EvolApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 299
	...
	%struct.DSOCacheEntry {
		i64 16962298063321081583, ; hash 0xeb663037ee8ca6ef, from name: EvolApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
	...
	%struct.DSOCacheEntry {
		i64 17034372332328139508, ; hash 0xec663f6260293af4, from name: aot-EvolApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-EvolApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 457
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0d3ffd50-c37c-4954-b609-3be7e058bc1d\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [16 x i8] c"EvolSRL.EvolApp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-EvolApp.dll.so\00", align 16
